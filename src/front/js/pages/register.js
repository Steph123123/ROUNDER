      ...
      <div className=" registro">
            ...
            <div className="regform row">
                <div className="firstform col mt-2">
                    <label for="  formGroupExampleInput" className="reglabel form-label">Name</label>
                ...
                <div className="col mt-2">
                    <label for="formGroupExampleInput" className="reglabel form-label">Last Name</label>
            ...
            <div className="regform row">
                <div className="col mt-2">
                    <label for=" formGroupExampleInput" className="reglabel form-label"> User Name</label>
                ...
                <div className="col mt-2">
                    <label for=" formGroupExampleInput" className="reglabel form-label">DNI</label>
            ...
            <div className="regform row">
                <div className="col mt-2">
                    <label for=" formGroupExampleInput" className="reglabel form-label">e-mail</label>
                ...
                <div className="col mt-2">
                    <label for=" formGroupExampleInput" className="reglabel form-label">Password</label>
            ...
            <button type="button" className="regbtn btn btn-primary mt-5" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onClick={() => {
